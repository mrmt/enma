 ...
 *
 * $Id: intarray.c 343 2008-08-13 08:30:15Z tsuruda $
 */
/**
 * @file
 * @brief INT 値を格納する可変長配列
 * @author takahiko@iij.ad.jp
 * @version $Id: intarray.c 343 2008-08-13 08:30:15Z tsuruda $
 */

#include "rcsid.h"
RCSID("$Id: intarray.c 343 2008-08-13 08:30:15Z tsuruda $");
