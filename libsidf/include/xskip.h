 ...
 *
 * $Id: xskip.h 196 2008-07-17 06:02:56Z takahiko $
 */
/**
 * @file
 * @brief RFC2045/2821/2822/4871 等で定義される文字クラスかを調べるためのマクロ
...
// RFC 2045
extern int XSkip_mimeTokenBlock(const char *head, const char *tail, const char **nextp);
